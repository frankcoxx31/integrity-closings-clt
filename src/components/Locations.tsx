    ...
    <section id="locations" className="py-20 bg-slate-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="mt-4 text-lg text-slate-600">I proudly serve Charlotte, Matthews, Mint Hill, Concord, Pineville, Monroe, and surrounding areas. If you're searching for a mobile notary near you, I come directly to your location.</p>
        </div>
