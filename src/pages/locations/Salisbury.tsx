    ...
    <CityPageLayout
      ...
      services={[
        ...
        },
        {
          ...
          description: <>Fast and reliable notarization for affidavits, vehicle titles, and school forms. I meet you at any <strong>Salisbury</strong> location for your convenience.</>,
      ...
      hospitalsIntro="Legal matters don't stop for medical emergencies. I provide compassionate, mobile notary services to patients and families at the primary healthcare hubs in the Salisbury area:"
      hospitals={[
        {
          name: "Novant Health Rowan Medical Center",
          location: "Salisbury, NC",
          description: <>I provide bedside notary services for medical POAs, living wills, and other urgent documents for patients at Novant Health near <strong>Mocksville Ave</strong>.</>
        },
        {
          name: "W.G. (Bill) Hefner VA Medical Center",
          location: "Salisbury, NC",
          description: <>Conveniently serving my veterans and their families. I offer flexible scheduling to meet you or your loved ones at the VA Medical Center.</>
        }
      ]}
      additionalLocations={[
      ...
      faqs={[
        {
          ...
          answer: "Yes! I frequently meet students, faculty, and staff at Catawba College and Livingstone College for various notary needs."
        },
        {
          question: "Do you offer mobile notary services at the Salisbury VA Medical Center?",
          answer: "Absolutely. I am honored to serve my veterans and can meet you at the W.G. (Bill) Hefner VA Medical Center for any necessary document notarization."
        },
        {
          question: "Are you available for weekend notary services in Salisbury?",
          answer: "Yes, I offer 24/7 mobile notary services by appointment, including Saturdays and Sundays, to ensure your documents are handled on your schedule."
        },
        {
          question: "How much is the travel fee for Salisbury?",
          answer: "My travel fees are competitive and based on the specific location in Salisbury and the time of day. Contact me for a quick and transparent quote."
        }
      ]}
