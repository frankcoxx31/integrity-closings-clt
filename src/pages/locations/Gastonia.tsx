...
export default function Gastonia() {
  return (
    <CityPageLayout
      ...
      introText={
        <>
          Need a <strong>mobile notary in Gastonia, NC</strong>? Integrity Closings CLT provides professional, on-demand notary services throughout Gaston County. Whether you're at a local coffee shop in the <strong>Historic District</strong>, a business near <strong>Franklin Square</strong>, or your own front door, I bring the notary office to you. I am committed to providing Gastonia residents with secure, accurate, and stress-free notarizations for all their legal and financial documents.
        </>
      }
      services={[
        {
          title: "Loan Signing Services",
          description: <>Expert handling of mortgages, refinances, HELOCs, and seller packages. I serve homeowners in neighborhoods like <strong>Loray Mill, Boogertown, and Ranlo</strong>.</>,
          icon: <FileSignature className="w-6 h-6 text-brand-600" />,
          link: "/loan-signing-agent-charlotte-nc"
        },
        {
          title: "Estate Planning Notary",
          description: <>Secure notarization for Power of Attorney (POA), Wills, and Trusts. I am happy to meet at local landmarks such as <strong>Schiele Museum</strong> or the <strong>Gaston County Public Library</strong>.</>,
        ...
        },
        {
          ...
          description: <>Mobile notarization for affidavits, I-9 verifications, and vehicle titles. I meet you anywhere in <strong>Gastonia</strong> for your convenience.</>,
      ...
      hospitalsIntro="Legal matters don't stop for medical emergencies. I provide compassionate, mobile notary services to patients and families at the primary healthcare hubs in the Gastonia area:"
      hospitals={[
        {
          name: "CaroMont Regional Medical Center",
          location: "Gastonia, NC",
          description: <>I provide bedside notary services for medical POAs, living wills, and other urgent documents for patients at CaroMont near <strong>Court Drive</strong>.</>
        },
        {
          name: "Peak Resources Gastonia",
          location: "Gastonia, NC",
          description: <>Conveniently serving rehabilitation and nursing facilities. I offer flexible scheduling to meet you or your loved ones to handle important legal paperwork.</>
        }
      ]}
      additionalLocations={[
      ...
      faqs={[
        {
          ...
          answer: "I can often have a notary at your location in Gastonia within 60-90 minutes, depending on current availability and traffic."
        },
        {
          question: "Do you offer notary services near Franklin Square?",
          answer: "Yes! I frequently serve the Franklin Square area, meeting clients at offices, restaurants, or their homes in the surrounding neighborhoods."
        },
        {
          question: "Can you notarize documents at CaroMont Regional Medical Center?",
          answer: "Absolutely. I frequently provide bedside notary services at CaroMont for medical directives, powers of attorney, and other urgent legal documents."
        },
        {
          question: "What are your hours for mobile notary in Gastonia?",
          answer: "I offer 24/7 mobile notary services by appointment. This includes evenings, weekends, and holidays to accommodate your busy schedule."
        }
      ]}
