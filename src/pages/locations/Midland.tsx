...
export default function Midland() {
  return (
    <CityPageLayout
      ...
      introText={
        <>
          Need a reliable, professional <strong>mobile notary in Midland, NC</strong>? Integrity Closings CLT provides fully on-demand notary services throughout Cabarrus County and nearby communities. Whether you're near <strong>Highway 24/27</strong>, relaxing at <strong>Rob Wallace Park</strong>, or signing documents in the comfort of your own home, my mobile notary service brings precision, efficiency, and integrity straight to your doorstep.
        </>
      }
      services={[
        {
          title: "Loan Signing Services",
          description: <>Professional handling of mortgage refinances, HELOCs, and seller packages. I work with lenders and title companies to provide stress-free mobile closings for residents of <strong>Midland and Mount Pleasant</strong>.</>,
        ...
        },
        {
          ...
          description: <>Secure mobile notarization for Living Trusts, Last Will and Testament, and Power of Attorney (POA). I can meet you at your home or popular spots like <strong>Reed Gold Mine</strong> area.</>,
          icon: <FileText className="w-6 h-6 text-brand-600" />,
          link: "/estate-notary-charlotte-nc"
        },
        {
          title: "Hospital & Bedside Notary",
          description: <>Bedside notarizations for directives, proxies, and urgent legal documents. I serve local clinics, rehabilitation centers, and nearby hospitals.</>,
      ...
      hospitalsIntro="Should legal needs present themselves during an unexpected medical stay or health challenge, I provide gentle, prompt mobile bedside notary services across Midland and surrounding clinic facilities:"
      hospitals={[
        {
          name: "Atrium Health Cabarrus (Nearby)",
          location: "Concord / Midland Region",
          description: <>I offer complete compassionate bedside notarization for medical powers of attorney, healthcare directives, and estate planning documents for patients and families.</>
        },
        {
          name: "Local Midland/Locust Medical Clinics",
          location: "Midland, NC",
          description: <>I am fully mobile and available to travel directly to outpatient centers, medical offices, and physical rehabilitation campuses throughout Cabarrus County.</>
        }
      ]}
      additionalLocations={[
        "Rob Wallace Park",
      ...
      faqs={[
        {
          ...
          answer: "Yes, I can meet you at any location in Midland, NC, including famous town spots like Reed Gold Mine or local parks, libraries, coffee stations, or right to your residence."
        },
        {
        ...
        },
        {
          ...
          answer: "Yes! I specialize in emergency and after-hours mobile notary services, operating in Midland 24 hours a day, 7 days a week by appointment."
        },
        {
