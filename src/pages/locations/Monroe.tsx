    ...
    <CityPageLayout
      ...
      services={[
        ...
        },
        {
          ...
          description: <>Professional notary support for business contracts and employment paperwork. I meet you at your office or <strong>Monroe</strong> area businesses.</>,
          icon: <Laptop className="w-6 h-6 text-brand-600" />,
          link: "/services/business-documents"
        }
      ]}
      hospitalsIntro="Legal matters don't stop for medical emergencies. I provide compassionate, mobile notary services to patients and families at the primary healthcare hubs in the Monroe area:"
      hospitals={[
        {
          name: "Atrium Health Union",
          location: "Monroe, NC",
          description: <>I provide bedside notary services for medical POAs, living wills, and other urgent documents for patients at Atrium Health near <strong>Highway 74</strong>.</>
        },
        {
      ...
      faqs={[
        {
          ...
          answer: "Yes! I can meet you at Treehouse Vineyards or any other local landmark in Monroe for your convenience."
        },
        {
          question: "Do you offer mobile notary services at Atrium Health Union?",
          answer: "Absolutely. I provide prompt bedside notary services at Atrium Health Union for medical directives, powers of attorney, and other urgent legal documents."
        },
        {
          question: "Are you available for after-hours notary in Monroe?",
          answer: "Yes, I offer 24/7 mobile notary services by appointment in Monroe, including evenings, weekends, and holidays."
        },
        {
