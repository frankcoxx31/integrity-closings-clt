...
export default function MintHillLoanSigning() {
  return (
    <LoanSigningCityLayout
      ...
      overviewText={
        <>
          <p>Integrity Closings CLT operates as a dedicated <strong>loan signing agent in Mint Hill, NC</strong>, specializing in high-stakes mortgage document appointments. I understand that local residents and lenders require a mobile partner who is both reliable and well-versed in loan packages.</p>
          <p>My service brings the closing table to your preferred location—whether that's your residence near <strong>Fairview Rd</strong>, a professional setting in <strong>Brighton Park</strong>, or a public meeting point on <strong>Matthews-Mint Hill Rd</strong>. I prioritize accuracy in every signature to prevent delays in your transaction.</p>
        </>
      }
      coverageAreas={[
        "Mint Hill",
      ...
      faqs={[
        {
          ...
          answer: "Yes. I frequently handle purchase closings for buyers in Mint Hill, ensuring all mortgage documents and deeds are executed correctly."
        },
        {
          question: "Are you available for evening loan signings in Mint Hill?",
          answer: "I offer flexible scheduling, including limited evening appointments, to accommodate borrowers' work schedules in Mint Hill and surrounding areas."
        }
      ]}
